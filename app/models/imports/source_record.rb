module Imports
  class SourceRecord < ApplicationRecord
    ...
    has_one :airline_source_link, class_name: "Imports::AirlineSourceLink", foreign_key: :source_record_id, inverse_of: :source_record, dependent: :restrict_with_exception
