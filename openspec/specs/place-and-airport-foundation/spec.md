# place-and-airport-foundation Specification

## Purpose
Define Routeprint's canonical fixed-wing airport reference records, localized
place names, spatial storage, timezone metadata, public-code lookup boundary,
and retention of closed airports for historical travel.
## Requirements
