...
| Business use case or `app/interactors` change | `$routeprint-yabi-interactor` | `app/interactors/application_interactor.rb`, target interactor/spec, one neighbor | Narrow interactor/request spec, then selected gate |
